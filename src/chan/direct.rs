...
{
    /// Publish a message onto a direct queue with the name produced by
    /// [DirectBus::queue] given the passed [DirectBus::Args]
...
impl Channel for DirectChannel {
    async fn publish_with_properties(
        ...
        debug!(
            "Publishing message with correlation UUID {correlation_uuid} a direct channel with \
